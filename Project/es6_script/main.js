...
let allImageCoddingBlocks = []; // unused, just making sure GC will not nuke the IMGcoddingBlocks objects
let allAnimationEventListeners = [];
let allLoadedSpriteImagesAsPaths = [];
let allLoadedSpriteImagesAsObjects = [];
let repaintOfCanvasRequestedDueMoving = false;
let repaintOfCanvasRequestedDueAnimation = false;
