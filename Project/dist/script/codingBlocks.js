...
var StepLeftBlock = function (_DockingCodingFigure4) {
    ...
    function StepLeftBlock(x, y) {
        ...
        return _possibleConstructorReturn(this, (StepLeftBlock.__proto__ || Object.getPrototypeOf(StepLeftBlock)).call(this, corpse, svg, x, y));
    }
...
var StaticInventoryStepLeftBlock = function (_StaticInventoryCodin4) {
    ...
    function StaticInventoryStepLeftBlock() {
        _classCallCheck(this, StaticInventoryStepLeftBlock);

        var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        var corpse = CreateShape(svg, loopsColor, true, true, [new Title(svg, shapesWallsWidth, titleOffsetY + heightOfBumb, 'STEP LEFT')], false, false);
        return _possibleConstructorReturn(this, (StaticInventoryStepLeftBlock.__proto__ || Object.getPrototypeOf(StaticInventoryStepLeftBlock)).call(this, corpse, svg));
    }
...
var StepRigthBlock = function (_DockingCodingFigure5) {
    ...
    function StepRigthBlock(x, y) {
        ...
        return _possibleConstructorReturn(this, (StepRigthBlock.__proto__ || Object.getPrototypeOf(StepRigthBlock)).call(this, corpse, svg, x, y));
    }
...
var StaticInventoryStepRightBlock = function (_StaticInventoryCodin5) {
    ...
    function StaticInventoryStepRightBlock() {
        _classCallCheck(this, StaticInventoryStepRightBlock);

        var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        var corpse = CreateShape(svg, loopsColor, true, true, [new Title(svg, shapesWallsWidth, titleOffsetY + heightOfBumb, 'STEP RIGHT')], false, false);
        return _possibleConstructorReturn(this, (StaticInventoryStepRightBlock.__proto__ || Object.getPrototypeOf(StaticInventoryStepRightBlock)).call(this, corpse, svg));
    }
...
var StepUPBlock = function (_DockingCodingFigure6) {
    ...
    function StepUPBlock(x, y) {
        ...
        return _possibleConstructorReturn(this, (StepUPBlock.__proto__ || Object.getPrototypeOf(StepUPBlock)).call(this, corpse, svg, x, y));
    }
...
var StaticInventoryStepUPBlock = function (_StaticInventoryCodin6) {
    ...
    function StaticInventoryStepUPBlock() {
        _classCallCheck(this, StaticInventoryStepUPBlock);

        var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        var corpse = CreateShape(svg, loopsColor, true, true, [new Title(svg, shapesWallsWidth, titleOffsetY + heightOfBumb, 'STEP UP')], false, false);
        return _possibleConstructorReturn(this, (StaticInventoryStepUPBlock.__proto__ || Object.getPrototypeOf(StaticInventoryStepUPBlock)).call(this, corpse, svg));
    }
...
var StepDownBlock = function (_DockingCodingFigure7) {
    ...
    function StepDownBlock(x, y) {
        ...
        return _possibleConstructorReturn(this, (StepDownBlock.__proto__ || Object.getPrototypeOf(StepDownBlock)).call(this, corpse, svg, x, y));
    }
...
var StaticInventoryStepDownBlock = function (_StaticInventoryCodin7) {
    ...
    function StaticInventoryStepDownBlock() {
        _classCallCheck(this, StaticInventoryStepDownBlock);

        var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        var corpse = CreateShape(svg, loopsColor, true, true, [new Title(svg, shapesWallsWidth, titleOffsetY + heightOfBumb, 'STEP DOWN')], false, false);
        return _possibleConstructorReturn(this, (StaticInventoryStepDownBlock.__proto__ || Object.getPrototypeOf(StaticInventoryStepDownBlock)).call(this, corpse, svg));
    }
...
var StartBlock = function (_DelleteableCodingBlo2) {
    ...
    function StartBlock(x, y) {
        ...
        var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        var corpse = CreateShape(svg, loopsColor, false, true, [new Title(svg, shapesWallsWidth, titleOffsetX, titleOffsetY, 'START')], false, false);
        return _possibleConstructorReturn(this, (StartBlock.__proto__ || Object.getPrototypeOf(StartBlock)).call(this, corpse, svg, x, y));
    }
