...
class Sprite {
    constructor(spriteImgPath,  // path to the image as string
        ...
        this.spriteWidth = imgOnCanvasX;
        this.spriteHeight = this.spriteWidth * (this.image.height / this.image.width);
...
class AnimatedSprite extends Sprite {
    constructor(spriteImgPath,
        ...
        console.log('scaleXofTheBackgrnd: ' + scaleXofTheBackgrnd + ' scaleYofTheBackgrnd: ' + scaleYofTheBackgrnd);
